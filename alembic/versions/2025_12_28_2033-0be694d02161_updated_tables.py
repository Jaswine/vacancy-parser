...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_status",
            sa.Enum("ACTIVE", "BLOCKED", "ARCHIVED", name="status"),
            nullable=False,
        ),
        sa.Column(
            "account_type",
            sa.Enum("ADMIN", "SIMPLE", name="accounttype"),
            nullable=False,
        ),
        sa.Column(
            "last_login",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "PENDING", "PAID", "OVERDUE", "CANCELLED", name="invoicestatus"
            ),
            nullable=False,
        ),
        sa.Column("expires_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(
        op.f("ix_collection_links_id"), "collection_links", ["id"], unique=False
    )
    op.create_table(
        "filters",
        sa.Column("collection_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "work_format",
            sa.Enum("OFFICE", "HYBRID", "REMOTE", name="filterworktype"),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_filters_collection_id"), "filters", ["collection_id"], unique=False
    )
